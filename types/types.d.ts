...
declare const BoundPatcher: {
    ...
    unpatchAll: () => void;
    before: (moduleToPatch: object, functionName: string, callback: any, options?: {
        displayName?: string | undefined;
        forcePatch?: boolean | undefined;
    } | undefined) => any;
    instead: (moduleToPatch: object, functionName: string, callback: any, options?: {
        displayName?: string | undefined;
        forcePatch?: boolean | undefined;
    } | undefined) => any;
    after: (moduleToPatch: object, functionName: string, callback: any, options?: {
        displayName?: string | undefined;
        forcePatch?: boolean | undefined;
    } | undefined) => any;
};
...
declare const returned: {
    new (): {
        ...
        buildSetting(data: any): Textbox | ColorPickerSetting | FilePicker | Slider | Switch | Dropdown | Keybind | RadioGroup | null;
