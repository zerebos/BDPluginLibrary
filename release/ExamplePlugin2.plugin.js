//META{"name":"ExamplePlugin2","displayName":"Example Plugin2","website":"","source":""}*//
...
var ExamplePlugin2 = (() => {
    ...
    return !global.ZLibrary ? class {
		...
		async load() {
			...
			global["ExamplePlugin2"] = plugin;
			try {new vm.Script(`new global["ExamplePlugin2"]();`, {displayErrors: true});} catch(err) {return bdpluginErrors.push({name: this.getName(), file: this.getName() + ".plugin.js", reason: "Plugin could not be constructed", error: {message: err.message, stack: err.stack}});}
			bdplugins[this.getName()].plugin = new global["ExamplePlugin2"]();
